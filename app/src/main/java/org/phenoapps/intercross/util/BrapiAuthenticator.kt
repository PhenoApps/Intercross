...
import org.phenoapps.brapi.provider.R

class BrapiAuthenticator(context: Context) : BrapiAccountAuthenticator(
    context = context,
    addAccountActivityClass = org.phenoapps.intercross.activities.BrapiAddAccountActivity::class.java,
    authTokenLabel = context.getString(
        R.string.pheno_brapi_auth_token_label,
    ),
) {

    companion object {
        /**
         * Intercross's own BrAPI account type.
         *
